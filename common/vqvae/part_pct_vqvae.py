...
from common.vqvae.vae_utils.part_pctvqvae import PART_PCTVQVAE

class PART_PCT_VQVAE(PART_PCTVQVAE):
    ...
    def forward(self,mode, x, target=None):
        ...
        recoverd_pose, e_latent_loss =super().forward(gt_pose_mat)
    ...
    def get_first_latent_code(self,gt_pose):
        B,C = gt_pose.shape
