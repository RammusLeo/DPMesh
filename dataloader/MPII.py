...
class MPII(torch.utils.data.Dataset):
    def __init__(self, transform, data_split):
        ...
        self.img_path = osp.join(cfg.root_dir, 'data', 'MPII')
        self.annot_path = osp.join(cfg.root_dir, 'data', 'MPII', 'annotations')
    ...
    def __getitem__(self, idx):
        ...
        """
        input_mpii_joint_img[:, 0] = input_mpii_joint_img[:, 0] / cfg.input_img_shape[1] * cfg.input_hm_shape[1]
        input_mpii_joint_img[:, 1] = input_mpii_joint_img[:, 1] / cfg.input_img_shape[0] * cfg.input_hm_shape[0]
        ...
        meta_info = {'cliff_focal_length': cliff_focal_length,
                    'orig_joint_valid': mpii_joint_valid, 
                    'orig_joint_trunc': mpii_joint_trunc, 
