...
class My_MSCOCO_v2_skele(torch.utils.data.Dataset):
    def __init__(self, transform, data_split):
        ...
        self.annot_path_new = osp.join('data', 'annotations', 'mscoco2.pkl')
    ...
    def __getitem__(self, idx):
        ...
        if self.data_split == 'train':
            ...
            input_kp_trunc = transform_joint_to_other_db(coco_joint_trunc, self.joints_name, self.openpose_joints_name)
            input_kp_img = transform_joint_to_other_db(input_coco_joint_img, self.coco_joints_name, self.openpose_joints_name)
            ...
            # teacher_inputs = {'img': img_teacher, 'joints_mask': joint_mask, 'joints': coco_joint_img}
