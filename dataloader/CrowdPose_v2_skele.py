...
class CrowdPose_v2_skele(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.data_split == 'train':
            ...
            """
            # newimg = vis_keypoints_with_skeleton(rawimg.transpose, input_crowdpose_joint_img.T, self.crowdpose_skeleton)
            # cv2.imwrite("duibi.jpg",newimg)
            ...
            input_kp_trunc = transform_joint_to_other_db(crowdpose_joint_trunc, self.joints_name, self.openpose_joints_name)
            input_kp_img = transform_joint_to_other_db(input_crowdpose_joint_img, self.crowdpose_joints_name, self.openpose_joints_name)
