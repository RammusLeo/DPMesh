...
class My_MuCo_v2_skele(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input_skeleton_img = vis_keypoints_with_skeleton_fortrain(input_kp_img.T,
                                                                    ...
                                                                    self.openpose_color)
        cv2.imwrite("testviskp5.jpg",input_skeleton_img)
        ...
        # if torch.sum(muco_joint_trunc)<10:
        ...
        inputs = {'img': img, 'joints_mask': muco_joint_trunc, 'joints': input_muco_joint_img[:, :2]}
        ...
        meta_info = {'cliff_focal_length': cliff_focal_length,'orig_joint_valid': muco_joint_valid, 'orig_joint_trunc': muco_joint_trunc, 
