...
from common.utils.vis import save_obj, vis_keypoints_with_skeleton, vis_bbox, render_mesh


class PW3D_SSL(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        images = {'img_teacher': img_teacher}
        inputs = {'joints': joint_coord_img, 'joints_mask': joint_trunc}
        ...
        return images,inputs, targets, meta_info
